...
for c in countries:
    ...
    popt_exponential, pcov_exponential = scipy.optimize.curve_fit(exponential, X_regression, y_regression, p0=[0.5, -0.5], maxfev=2000)
...
aligned_countries.to_csv('data/predict_daily_growth_confirmed_comparison.csv')
